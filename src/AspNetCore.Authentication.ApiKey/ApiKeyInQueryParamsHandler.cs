...
namespace MadEyeMatt.AspNetCore.Authentication.ApiKey
{
	...
	public class ApiKeyInQueryParamsHandler : ApiKeyHandlerBase
	{
		...
		public ApiKeyInQueryParamsHandler(IOptionsMonitor<ApiKeyOptions> options, ILoggerFactory logger, UrlEncoder encoder)
...
#if NET6_0 || NET7_0
		public ApiKeyInQueryParamsHandler(IOptionsMonitor<ApiKeyOptions> options, ILoggerFactory logger, UrlEncoder encoder, ISystemClock systemClock)

...
namespace MadEyeMatt.AspNetCore.Authentication.ApiKey
{
	...
	/// <summary>
	///     Inherited from <see cref="AuthenticationSchemeOptions" /> to allow extra option properties for 'ApiKey'
	///     authentication.
	/// </summary>
	public class ApiKeyOptions : AuthenticationSchemeOptions
	{
		...
		/// <summary>
		///     Default value is false.
		///     If set to true, <see cref="IApiKey.Key" /> property returned from
		///     <see cref="IApiKeyAuthenticationService.AuthenticateAsync" /> method is not compared with the key parsed from the
		///     request.
		///     This extra check did not existed in the previous version. So you if want to revert back to old version validation,
		...
		/// <summary>
		///     Default value is false.
		///     If set to true then value of <see cref="KeyName" /> property is used as scheme name on the WWW-Authenticate
		///     response header when challenging un-authenticated requests.
		///     else, the authentication scheme name (set when adding this authentication to the authentication builder) is used as
		///     scheme name on the WWW-Authenticate response header when challenging un-authenticated requests.
		/// </summary>

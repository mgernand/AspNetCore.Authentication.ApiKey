...
namespace MadEyeMatt.AspNetCore.Authentication.ApiKey.Tests
{
	...
	public class ApiKeyInAuthorizationHeaderHandlerTests : IDisposable
	{
		...
		{
			this._server = MadEyeMatt.AspNetCore.Authentication.ApiKey.Tests.Infrastructure.TestServerBuilder.BuildInAuthorizationHeaderServer();
			this._client = this._server.CreateClient();

			this._serverWithProvider = MadEyeMatt.AspNetCore.Authentication.ApiKey.Tests.Infrastructure.TestServerBuilder.BuildInAuthorizationHeaderServerWithProvider();
			this._clientWithProvider = this._serverWithProvider.CreateClient();

			this._serverWithProviderFactory = MadEyeMatt.AspNetCore.Authentication.ApiKey.Tests.Infrastructure.TestServerBuilder.BuildInAuthorizationHeaderServerWithProviderFactory();

...
namespace MadEyeMatt.AspNetCore.Authentication.ApiKey.Tests
{
	...
	public class ApiKeyInHeaderHandlerTests : IDisposable
	{
		...
		{
			this._server = MadEyeMatt.AspNetCore.Authentication.ApiKey.Tests.Infrastructure.TestServerBuilder.BuildInHeaderServer();
			this._client = this._server.CreateClient();

			this._serverWithProvider = MadEyeMatt.AspNetCore.Authentication.ApiKey.Tests.Infrastructure.TestServerBuilder.BuildInHeaderServerWithProvider();
			this._clientWithProvider = this._serverWithProvider.CreateClient();

			this._serverWithProviderFactory = MadEyeMatt.AspNetCore.Authentication.ApiKey.Tests.Infrastructure.TestServerBuilder.BuildInHeaderServerWithProviderFactory();
		...
		public async Task Verify_challenge_www_authenticate_header()
		{
			...
			Assert.Equal($"realm=\"{MadEyeMatt.AspNetCore.Authentication.ApiKey.Tests.Infrastructure.TestServerBuilder.Realm}\", charset=\"UTF-8\", in=\"header\", key_name=\"{MadEyeMatt.AspNetCore.Authentication.ApiKey.Tests.Infrastructure.FakeApiKeys.KeyName}\"", wwwAuthenticateHeaderToMatch.Parameter);
		}

...
namespace MadEyeMatt.AspNetCore.Authentication.ApiKey.Tests
{
    ...
    public class ApiKeyInHeaderHandlerTests : IDisposable
    {
        ...
        {
			_server = MadEyeMatt.AspNetCore.Authentication.ApiKey.Tests.Infrastructure.TestServerBuilder.BuildInHeaderServer();
			_client = _server.CreateClient();

			_serverWithProvider = MadEyeMatt.AspNetCore.Authentication.ApiKey.Tests.Infrastructure.TestServerBuilder.BuildInHeaderServerWithProvider();
			_clientWithProvider = _serverWithProvider.CreateClient();

			_serverWithProviderFactory = MadEyeMatt.AspNetCore.Authentication.ApiKey.Tests.Infrastructure.TestServerBuilder.BuildInHeaderServerWithProviderFactory();
